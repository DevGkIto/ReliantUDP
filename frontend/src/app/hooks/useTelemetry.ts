    ...
    ws.onmessage = (message) => {
      try {
        ...
        setMetrics((prev) => {
          ...
          if (data.seq === 0 && data.event === 'packet_sent' && data.attempt === 1) {
        ...
        setPacketState((prev) => {
          ...
          else if (data.event === 'packet_timeout' || data.event === 'retransmit') newState[data.seq] = 'lost';
          else if (data.event === 'packet_sent' && newState[data.seq] !== 'acked') newState[data.seq] = 'sent';

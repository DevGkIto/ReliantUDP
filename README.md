# Reliable-UDP: Custom ARQ Protocol & Chaos Telemetry Suite

A full-stack, distributed system demonstrating a custom Reliable UDP (Stop-and-Wait ARQ) protocol, real-time telemetry streaming, and server-side chaos engineering. Developed as a assignment for the Computer Networks class at the Federal Technological University of Paraná (UTFPR).
...
- **Frontend:** Next.js / React dashboard visualizing packet state machines.
